...
> 功能冻结说明日期: 2026-07-11（相对当时主线）  
> **发布状态（2026-07-18）**：源码在 GitHub `main`；**尚未**打 git tag / 创建 GitHub Release。本文是版本说明草稿，不是已上架的正式发版公告。

> **Phase 编号**：下文「Phase 1–3」指 **DEV-PLAN 交付切片**（v0.1.0 内）。Product-Spec §9 的「Phase 2 = Harness」尚未开始，见文末路线图。

---

## 概述

Tepeu v0.1.0 是首个**可运行的产品里程碑**（个人 Agent 工作台）：多面板布局、Agent 对话（SSE）、Workspace、记忆、文件浏览器与终端。正式发版包（tag / GitHub Release）见「已知限制」。

**核心理念：模型是 CPU，Tepeu 是操作系统。**

---

## 功能清单（DEV-PLAN 切片，v0.1.0）

### DEV-PLAN Phase 1 — 核心底座 ✅
...
### DEV-PLAN Phase 3 — 记忆 UI + 文件增强 + 终端 ✅
...
## 路线图（Product-Spec §9，非上文 DEV-PLAN 切片）

...
```
Runtime: Java 21
Mainline: os/（Maven；组件 session/policy/bus/llm/loop/orchestration/compose；词汇 identity/syscall）
...
```
os/               重写主线：组件 session/policy/bus/llm/loop/orchestration/compose；词汇 identity/syscall

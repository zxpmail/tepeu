...
| 里程碑 | 功能 | 交付物 | 状态 |
|--------|------|--------|------|
| M3.1 | 自主 Agent | 定时运行（Hands 能力包未做） | ✅ DEV-PLAN Phase 10 |
| M3.2 | WASM+V8 运行时 | GraalJS 沙箱（原生 WASM 延后，ADR-015） | ✅ DEV-PLAN Phase 17 |
| M3.3 | 应用市场 | 社区技能/工具分享 | ✅ DEV-PLAN Phase 16 |
| M3.4 | 多端适配 | 移动端响应式 | ✅ DEV-PLAN Phase 15 |
| M3.5 | v1.0.0 正式发布 | 发布说明 + 版本；集群高可用另立远期（§8.2） | ✅ 说明/版本收口；⏳ docker build / tag 可选 |

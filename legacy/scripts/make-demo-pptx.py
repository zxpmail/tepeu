#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""生成最小可预览的 demo PPTX，写入第一个含内容的工作区目录。"""
...
<p:sld xmlns:a="http://schemas.openxmlformats.org/drawingml/2006/main" xmlns:r="http://schemas.openxmlformats.org/officeDocument/2006/relationships" xmlns:p="http://schemas.openxmlformats.org/presentationml/2006/main">
  <p:cSld><p:spTree>
    ...
    <p:sp>
      ...
      <p:spPr><a:xfrm><a:off x="914400" y="1828800"/><a:ext cx="10363200" cy="1371600"/></a:xfrm>
        <a:prstGeom prst="rect"><a:avLst/></a:prstGeom></p:spPr>
      <p:txBody><a:bodyPr/><a:lstStyle/><a:p><a:r><a:rPr lang="zh-CN" sz="4400" b="1"/><a:t>Tepeu PPTX Preview</a:t></a:r></a:p></p:txBody>
    </p:sp>
  </p:spTree></p:cSld>
...
def find_workspace() -> Path:
    ...
    for candidate in backend.rglob("hello.py"):
...
def main() -> None:
    ws = find_workspace()
    out = ws / "tepeu-preview-demo.pptx"
